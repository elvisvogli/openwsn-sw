...
implementation {
   ...
   components NRESC             as RESC;
   //components URESC             as RESC;
   components NeighborsC;
   //02a-MAC
   components CellUsageC;
   components stupidMACC        as MACC;
   //components IEEE802154EC      as MACC;
   /* add 154E here */
   //01-PHY
